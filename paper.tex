...
A comprehensive ablation study across eight conditions (100{,}000 steps, three seeds each) reveals that vesicle communication dramatically reshapes population dynamics: populations with vesicles stabilize at approximately 50 cells versus 485 without, yet exhibit qualitatively richer energy cycling and sustained generational turnover.
...
Wall-clock time averages approximately 900 seconds per run on a single CPU core.

\subsection{Metrics}

We track the following quantities at each step and report summary statistics (mean $\pm$ standard deviation) computed over the final 10\% of each run (steps 90{,}000--100{,}000):
...
\midrule
Full System   & 50\tiny$\pm$2   & 0.70\tiny$\pm$.01 & 1.62\tiny$\pm$.10 & 11 \\
No Vesicle    & 280\tiny$\pm$10 & 2.89\tiny$\pm$.08 & 4.45\tiny$\pm$.23 & 0 \\
No Geno.\ Mod & 52\tiny$\pm$2   & 1.06\tiny$\pm$.06 & 1.32\tiny$\pm$.28 & 11 \\
No Sexual     & 53\tiny$\pm$1   & 1.69\tiny$\pm$.06 & 1.20\tiny$\pm$.05 & 12 \\
No Predation  & 49\tiny$\pm$3   & 2.92\tiny$\pm$.10 & 4.91\tiny$\pm$.23 & 10 \\
No Speciation & 55\tiny$\pm$2   & 0.48\tiny$\pm$.07 & 0.38\tiny$\pm$.04 & 12 \\
...
\begin{figure}[t]
  ...
  \caption{Population dynamics over 100{,}000 steps. The No Vesicle condition sustains $\sim$485 cells at steady state, while the Full System stabilizes near 50.}
...
The No Vesicle condition sustains approximately $483 \pm 5$ cells, whereas the Full System stabilizes at $50 \pm 2$---a ten-fold reduction.
...
\begin{figure}[t]
  ...
  \caption{Maximum generation reached over time. No Vesicle reaches generation 132; Full System reaches 31; No Aging is arrested below 2 with near-zero deaths.}
  \label{fig:generations}
\end{figure}

The No Aging condition is a dramatic outlier: the population stabilizes at $230 \pm 0$ cells with near-zero deaths across all seeds, and the maximum generation reaches only $1.7 \pm 0.5$ (Figure~\ref{fig:generations}).
...
The mere 31 total births across 100{,}000 steps (compared to 424 for the Full System) confirm that reproduction is severely suppressed.
...
Among conditions with aging, the No Vesicle condition achieves the highest generational depth ($132 \pm 15$), consistent with its larger population providing more reproductive events.
The Full System reaches generation $31.3 \pm 3$, with fewer total births ($424 \pm 40$ vs.\ $3{,}968 \pm 300$ for No Vesicle) but richer per-capita dynamics.
...
Counterintuitively, removing sexual recombination \emph{increases} genome variance (No Sexual: $1.69 \pm 0.06$ vs.\ Full System: $0.70 \pm 0.01$).
...
Disabling genome modulation (fixing all $\alpha_q^{(h)} = \alpha_k^{(h)} = 0.5$) reduces phenotype variance from $1.62 \pm 0.10$ (Full System) to $1.32 \pm 0.28$---an 19\% decrease.
...
Disabling speciation pressure dramatically decreases genome variance ($0.48 \pm 0.07$ vs.\ Full System $0.70 \pm 0.01$) and phenotype variance ($0.38 \pm 0.04$ vs.\ $1.62 \pm 0.10$).
...
\begin{enumerate}
  ...
  \item \textbf{Small populations.} The steady-state populations of 50--485 cells are far below the scale at which complex ecological dynamics (food webs, trophic levels, competitive exclusion) typically emerge.
\end{enumerate}
